        ...
        (skill, index) =>
          skill.isVisible !== false && (
            <div
              ...
              style={{ flexBasis: skill.columnWidthPercent || undefined }}>
              <h3 style={{ fontFamily: font }}>{skill.category}</h3>
              {showSkillLevel
